...
public class CommentService {
	 ...
	 * @throws ForbiddenException si l'utilisateur n'est pas autorisé à commenter la
	 *                            salle
	 */
	public Comment create(Comment comment, User user) throws ForbiddenException {
	 ...
	 * 
	 * @param comment l'objet de type Comment contenant l'id de l'auteur et celui de
	 *                la salle
